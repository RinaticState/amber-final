...
There is a .csv file that will match the number ID to parameter name. Or consult the parameters table in the Summer 2019 REU Report to match the ID number with the parameter name.
